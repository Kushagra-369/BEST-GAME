                    ...
                    >
                        ...
                        <div className=' relative z-20 text-4xl md:text-6xl flex justify-between text-white items-center  py-10 md:py-30 font-extrabold  '>
                            ...
                            <div>
                                ...
                                <h1 className=' text-cyan-300 items-center py-5 md:py-10 px-10'> अब तक का सबसे अच्छा</h1>
                                <h1 className=' px-15'>समय को उल्टा करें.</h1>
                                <h1 className=' py-4 px-10 text-red-500'>कौन बचेगा?</h1>
