...
export default function Part1d() {
    return (
        <Element name="best">
                    ...
                    >
                        ...
                        <div className=' relative z-20 text-4xl md:text-6xl flex justify-between text-white items-center  py-10 md:py-30 font-extrabold  '>
                            ...
                            <div>
                                ...
                                <h1 className=' text-cyan-300 items-center py-5 md:py-10 px-10'> Jusqu'à présent le meilleur</h1>
                                <h1 className=' px-15'>Inversez le TEMPS.</h1>
                                <h1 className=' py-4 px-10 text-red-500'>Qui survivra ?</h1>
                                <div className=' flex gap-10 py-10 px-5 md:px-15'>
                                    <a href="https://youtu.be/AURVxvIZrmU?feature=shared">
                                        <div className='text-center items-center border-6 border-red-600 hover:border-amber-300 h-15 md:h-25 w-60 bg-white rounded-4xl hover:bg-cyan-300'>
                                            <h1 className=' py-2 text-black text-xl md:text-2xl '>Regarder la bande-annonce</h1>
                                        </div></a>
                                    <a href="">
                                        <div className=' hover:bg-cyan-300 text-center border-6 border-amber-300 h-15 md:h-25 w-60 hover:border-red-600 bg-white rounded-4xl'>
                                            <h1 className=' py-2 text-black text-xl md:text-2xl '>Apprendre encore plus</h1>
                                        </div>
                                    </a>
                                </div>
                            </div>
