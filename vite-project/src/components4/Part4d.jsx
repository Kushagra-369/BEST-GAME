...
export default function Part4d() {
    return (
        <Element name = "new">
        ...
        >
            <div className=' text-4xl md:text-6xl text-white items-center px-5 py-5 md:py-50 font-extrabold'>
                ...
                <h1 className=' text-cyan-300 items-center py-5 md:py-10'>Disponible maintenant</h1>
                <h1>Deux chronologies.</h1>
                <h1 className=' py-4 text-red-500'>Un mystère impossible.</h1>
